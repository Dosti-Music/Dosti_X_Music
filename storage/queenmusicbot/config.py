...
LOGGER_ID = int(getenv("LOGGER_ID",-1))

OWNER_ID = int(getenv("OWNER_ID", "7286267673"))

BOT_USERNAME = getenv("BOT_USERNAME" , "ll_Dosti_Music_ll_Bot")
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ll_Dosti_ll")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+v59kL0ptkmtiMmFl")
